...
void BlockChunk::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->prevHash);
    doParsimPacking(b,this->hash);
    doParsimPacking(b,this->txCount);
}
...
void BlockChunk::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->prevHash);
    doParsimUnpacking(b,this->hash);
    doParsimUnpacking(b,this->txCount);
}
...
int BlockChunk::getPrevHash() const
{
    return this->prevHash;
}

void BlockChunk::setPrevHash(int prevHash)
{
    handleChange();
    this->prevHash = prevHash;
}

int BlockChunk::getHash() const
{
    return this->hash;
}

void BlockChunk::setHash(int hash)
{
    handleChange();
    this->hash = hash;
}

int BlockChunk::getTxCount() const
{
    return this->txCount;
}

void BlockChunk::setTxCount(int txCount)
{
    handleChange();
...
unsigned int BlockChunkDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_prevHash
        FD_ISEDITABLE,    // FIELD_hash
        FD_ISEDITABLE,    // FIELD_txCount
    };
...
int BlockChunkDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "prevHash") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "hash") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "txCount") == 0) return baseIndex + 3;
...
std::string BlockChunkDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_prevHash: return long2string(pp->getPrevHash());
        case FIELD_hash: return long2string(pp->getHash());
        case FIELD_txCount: return long2string(pp->getTxCount());
        default: return "";
    }
}
...
void BlockChunkDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_prevHash: pp->setPrevHash(string2long(value)); break;
        case FIELD_hash: pp->setHash(string2long(value)); break;
        case FIELD_txCount: pp->setTxCount(string2long(value)); break;
...
omnetpp::cValue BlockChunkDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_prevHash: return pp->getPrevHash();
        case FIELD_hash: return pp->getHash();
        case FIELD_txCount: return pp->getTxCount();
...
void BlockChunkDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_prevHash: pp->setPrevHash(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_hash: pp->setHash(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_txCount: pp->setTxCount(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'BlockChunk'", field);
    }
}
